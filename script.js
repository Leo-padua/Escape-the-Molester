...
const game = {running: true, mode: ["survival", "battle"]}
...
const oliverImage = new Image()
oliverImage.src = "images/oliver2.jpg"
const molesterImage = new Image()
molesterImage.src = "images/yup.jpg"
...
class Monsta {
    ...
    draw() {
        ...
        c.closePath()
        if (game.mode == "battle") {
            this.image = molesterImage
            c.drawImage(molesterImage, this.position.x - Monsta.radius - 3, this.position.y - Monsta.radius - 3, 2.3 * Monsta.radius, 2.3 * Monsta.radius)
        } else if (game.mode == "survival") {
            this.image = oliverImage
            c.drawImage(oliverImage, this.position.x - Monsta.radius - 3, this.position.y - Monsta.radius - 3, 2.3 * Monsta.radius, 2.3 * Monsta.radius)
        }
    }
    update() {
        if (motionAllowed == true) {
